...
Se PowerShell blocca l'attivazione, applica una execution policy adatta al tuo account
oppure esegui direttamente `.\.venv\Scripts\python.exe -m pip install .`. Windows ARM64
non rientra nel supporto iniziale.
